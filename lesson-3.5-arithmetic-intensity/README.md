# Lesson 3.5 -- Arithmetic intensity
...
./build/arithmetic_intensity_demo
```
...
.\build\Release\arithmetic_intensity_demo.exe
```

This program queries your actual GPU and computes a ridge point
specific to it -- the printed numbers will reflect your card, not
necessarily an RTX 3050. See `expected_output.txt` for the shape of
correct output, not exact values.
